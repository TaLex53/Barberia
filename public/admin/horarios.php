...
<body class="bg-[#050505] text-slate-100 h-screen overflow-hidden flex selection:bg-white selection:text-black">
    ...
    <aside id="sidebar" class="hidden md:flex w-64 bg-[#0a0a0a] border-r border-white/5 flex-col flex-shrink-0 relative z-20 transition-all duration-300">
        ...
        <nav class="flex-1 py-6 px-4 space-y-2 overflow-y-auto">
            ...
            <a href="reportes" class="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-white hover:bg-white/5 rounded-xl font-semibold text-xs uppercase tracking-[0.1em] transition-all">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <div class="flex-1 overflow-y-auto p-4 md:p-8 pb-24 md:pb-8 relative">
            ...
            <div class="mb-8 flex justify-end">
                <button id="btnNuevoHorario" class="bg-white text-black px-5 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-[0.1em] hover:bg-slate-200 transition-colors flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(255,255,255,0.15)]">
    ...
    <nav class="md:hidden fixed bottom-0 left-0 w-full bg-[#0a0a0a] border-t border-white/10 z-50 flex justify-around items-center h-16 px-2">
        ...
        <a href="horarios" class="flex flex-col items-center justify-center w-full h-full text-white">
