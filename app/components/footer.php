<!-- Footer -->
<footer class="bg-black border-t border-white/10 pt-20 pb-12 relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div class="space-y-6 md:col-span-2">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 flex items-center justify-center overflow-hidden">
                    <img src="assets/img/favicon.png" alt="Cut Level Favicon" class="w-full h-full object-contain">
                </div>
                <span class="text-2xl font-heading tracking-widest text-white uppercase">CUT LEVEL BARBERÍA</span>
            </div>
            <p class="text-slate-400 text-sm leading-relaxed max-w-md">
                Definimos nuestra identidad desde el lujo sobrio y la elegancia contemporánea. Una propuesta masculina e
                impecable en cada detalle, creada para transmitir confianza absoluta, exclusividad y un alto nivel de
                sofisticación </p>
            <div class="flex items-center gap-3 text-slate-400">
                <a href="#" target="_blank" aria-label="Instagram"
                    class="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:text-primary hover:border-primary/50 transition-all hover:-translate-y-1">
                ...
                <a href="#" target="_blank" aria-label="Google"
                    class="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:text-primary hover:border-primary/50 transition-all hover:-translate-y-1">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path
        ...
        <!-- Col 2: Navigation -->
        <div class="space-y-4">
            <h4 class="text-xs font-bold uppercase tracking-[0.3em] text-primary">Navegación</h4>
            <ul class="space-y-2 text-sm text-slate-400 font-medium">
                ...
                <li><a href="reserva" target="_blank" class="text-primary hover:underline">Reservar Cita</a></li>
            </ul>
        </div>

        <!-- Col 3: Ubicación y Horarios -->
        <div class="space-y-4">
            <h4 class="text-xs font-bold uppercase tracking-[0.3em] text-primary">Ubicación & Horarios</h4>
            <div class="space-y-3 text-sm text-slate-400">
                ...
                <p class="flex items-start gap-2">
                    ...
                    <span>Lunes a sábado y festivos:<br>09:00 a 20:00 hrs</span>
                </p>
                <p class="flex items-start gap-2">
                    <span class="material-symbols-outlined text-primary text-base">call</span>
                    <span>Teléfono de contacto:<br>+56 9 2086 0076</span>
                </p>
            </div>
        </div>
...
<a href="https://wa.me/56920860076" target="_blank" rel="noopener noreferrer"
    class="fixed bottom-6 right-6 z-[999] bg-[#25D366] text-white w-14 h-14 rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:scale-110 transition-transform duration-300">
...
<?php include __DIR__ . '/security_shield.php'; ?>
</body>
